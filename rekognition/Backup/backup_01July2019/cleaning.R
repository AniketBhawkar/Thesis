...
travel = c("Travel", "Human", "Crowd", "Car", "Sedan", "Vehicle", "Transportation",
           "Airplane", "People", "Person", "Bus", "Automobile", "Road", "Highway","Freeway",
           "Outdoors", "Sea", "Nature", "Ocean", "Water", "Wilderness", "Rock", "Bush", "Weather",
           "Cloud", "Sky", "Landscape", "Sea Waves", "Sport", "Sports", "Scenery", "Bike",
           "Airport", "Aircraft", "Airfield", "Tire", "Bicycle", "Helmet", "Cyclist", "Jet", 
           "Airliner", "Flight", "Warplane", "Boat", "Pyramid", "Wheel", "Sports Car", "Car Wheel",
           "Tree", "Flower", "Rose", "Blossom", "Ruins", "Bird", "Soil", "Animal", "Sunset",
           "Dusk", "Red Sky", "Sunrise", "Camping", "Grassland", "Field", "Yard", "Land",
           "Mountain Tent", "Truck", "Countryside", "Traffic Light", "Train", "Railway", "Plant",
           "Wildlife", "Flood", "Lawn")
...
df$Category = ifelse(is.element(df$Label, travel),"Transport", 
